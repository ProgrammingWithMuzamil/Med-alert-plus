...
import { ArrowLeft, ShieldCheck, Watch, Wifi, Heart, Phone } from "lucide-react";
import watch from "@/assets/product-watch.jpg";

export const Route = createFileRoute("/guides/personal-4g-care-watch")({
  head: () => ({
    meta: [
      { title: "Personal 4G Care Watch Setup Guide - MediAlert+" },
      { name: "description", content: "Complete setup guide for the Personal 4G Care Watch with step-by-step instructions." },
    ],
  }),
  component: WatchGuide,
});
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1">
              ...
              <h1 className="font-display text-4xl font-bold text-navy md:text-5xl mb-4">
                Personal 4G Care Watch
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Complete setup instructions for your all-in-one smart medical alert watch with GPS, heart rate monitoring, and SOS features.
              </p>
            </div>
            <div className="w-full md:w-1/3">
              <img src={watch} alt="Personal 4G Care Watch" className="w-full rounded-2xl shadow-xl" />
            </div>
          </div>
        </div>
